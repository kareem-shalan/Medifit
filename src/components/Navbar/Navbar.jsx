...
export function Navbar() {
  ...
  const wishlistCount = wishlist.wishlistCount;
      ...
      <nav className='bg-white text-[#503217] py-3 sm:py-4 flex items-center justify-center'>
        <div className='flex justify-between items-center w-full max-w-[1200px] px-3 sm:px-4 md:px-6 lg:px-8'>
              ...
              <li>
                <NavLink
                  ...
                  className={function({ isActive }) {
                    return `font-medium text-lg hover:text-[#8B5A3C] active:text-[#8B5A3C] transition-colors duration-200 relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-[#8B5A3C] after:transition-all after:duration-300 hover:after:w-full active:after:w-full ${isActive ? 'text-[#8B5A3C] after:w-full' : ''}`
                  }}
                >
                  Home
                </NavLink>
          ...
          <div className='text-xl sm:text-2xl flex items-center justify-around gap-3 sm:gap-4'>
            ...
            <Link
              to="/wishlist"
              className='relative cursor-pointer hover:text-[#8B5A3C] active:text-[#8B5A3C] transition-colors duration-200 hover:scale-110 active:scale-110 transform'
            >
              <FaHeart />
              {wishlistCount > 0 && (
