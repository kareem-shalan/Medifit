...
export function MainHero() {
  return (
    <motion.div className='px-3 container mx-auto sm:px-4 md:px-6 lg:px-8  w-full flex flex-col md:flex-row items-center justify-center md:gap-2 lg:gap-4 xl:gap-6 py-6 sm:py-8 md:py-10 lg:py-12 '>
      ...
      <motion.div className='w-full md:w-1/2 lg:w-auto flex justify-center items-center mt-6 md:mt-0 order-1 md:order-2'>
        <motion.img className='w-full max-w-[300px] sm:max-w-[400px] md:max-w-[500px] lg:max-w-[500px] h-auto' src='/Images/HERO-Group 220.png' alt='hero-image' />
      </motion.div>
